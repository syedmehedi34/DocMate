...
const Services = () => {
  useEffect(() => {
    ...
    AOS.init({
      duration: 1000,
      once: false, // Ensures the animation happens every time the element comes into view
    });
  ...
  return (
    <div className="max-w-screen-xl mx-5 md:mx-auto my-20">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-9 gap-4">
        ...
        <div
          className="lg:col-span-3 md:col-span-3 col-span-1"
          data-aos="fade-up"
        >
          <div className="flex flex-col justify-between items-start p-2">
            <h2 className="text-lg text-blue-400">HEALTH FACILITIES</h2>
            <h3 className="text-2xl md:text-3xl font-medium my-4">
              Explore Medical Department List
            </h3>
        ...
        {[
          ...
          },
          {
            img: "assets/bone.png",
            title: "Spine Surgery",
            desc: "Advanced treatment for spinal disorders with expert surgeons and world-class care.",
          },
          {
            img: "assets/liver.png",
            title: "Organ Transplant",
            desc: "Life-saving transplants with top specialists and world-class medical facilities.",
          },
          {
          ...
          },
          {
            ...
            desc: "Expert care for joint, bone treatments with top surgeons.ensure best services",
          },
        ].map((service, index) => (
          <div
            key={index}
            className="lg:col-span-2 md:col-span-3 sm:col-span-2 col-span-1 flex items-center justify-center"
            data-aos="fade-up"
          >
        ...
        {/* Call Us Section */}
        <div
          className="relative lg:col-span-3 md:col-span-3 col-span-1 flex items-center justify-center p-4 rounded-2xl"
          data-aos="fade-up"
        >
          {/* Background Image with Overlay */}
          <div className="absolute inset-0 bg-[url('/assets/abouts-img1.jpg')] bg-cover bg-center bg-no-repeat opacity-30 rounded-2xl"></div>
          {/* Content */}
