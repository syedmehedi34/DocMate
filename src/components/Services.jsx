        ...
        <div className='max-w-screen-xl mx-auto my-20'>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-9 gap-4">
                ...
                {[ 
                    ...
                    <div key={index} className="lg:col-span-2 md:col-span-3 sm:col-span-2 col-span-1 flex items-center justify-center" data-aos="fade-up">
                ...
                {/* Call Us Section */}
                <div className="relative lg:col-span-3 md:col-span-3 col-span-1 flex items-center justify-center p-4 rounded-2xl" data-aos="fade-up">
