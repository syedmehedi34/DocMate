...
export default function Appointment() {
  return (
    <div
      className="relative bg-fixed bg-cover bg-center mb-20"
    ...
    >
      ...
      {/* content */}
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-20 pb-100 md:py-24 px-4 relative z-10">
        {/* text content */}
