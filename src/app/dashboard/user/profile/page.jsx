...
const ProfilePage = () => {
  ...
  return (
    <RoleGuard allowedRoles={["user"]}>
      <div className="min-h-screen bg-linear-to-b from-teal-50 to-cyan-100">
        {/* Banner */}
        <Parallax
          blur={{ min: -50, max: 50 }}
          ...
          strength={-200}
        >
          <div className="h-47.5 md:h-75 bg-opacity-60 bg-cover bg-center bg-no-repeat">
          ...
          <div className="bg-white/90 backdrop-blur-lg rounded-xl shadow-2xl p-8 md:p-12 transform transition-all hover:shadow-3xl">
            <div className="flex flex-col items-center">
              <div className="relative mb-6 group">
                <div className="absolute inset-0 bg-linear-to-r from-teal-400 to-cyan-500 rounded-full blur opacity-75 group-hover:opacity-100 transition duration-1000"></div>
                <img
                  alt={user?.name || "User"}
